...
public class Visitor {
    ...
    private int V_age, duration;
    private String V_address, relation_with_criminal;


    public Visitor(int visitor_id, String vf_name, String vm_name, String vl_name, int v_age, String v_address, int duration, String relation_with_criminal, int criminal_id) {
